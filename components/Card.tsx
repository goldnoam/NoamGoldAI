...
const Card: React.FC<CardProps> = ({ data, title, description, visitText }) => {
  return (
    <a
      ...
      className="group relative flex flex-col h-full bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-6 md:p-8 hover:bg-slate-800 hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-500/40 transition-all duration-300 transform hover:-translate-y-2 hover:scale-[1.02] overflow-hidden cursor-pointer"
    >
